...
type RequestPartyPackageFormProps = {
  sendEmail: (values: any) => Promise<void>
}

export default function RequestPartyPackageForm({sendEmail}: RequestPartyPackageFormProps):JSX.Element {
      ...
      <Grid container pt={1}>
        <Grid item xs={12}>
          <Typography align="center" fontSize={isMobile ? 18 : 24} fontWeight={700} sx={{color: "#945A02"}}>
            Request your own party package
          </Typography>
          <Typography align="center" fontSize={isMobile ? 18 : 24} fontWeight={700} sx={{color: "#945A02"}}>
              ...
              return (
                <Form>
                  <Grid container spacing={1} justifyContent={"center"}>
                    ...
                    <Grid item xs={12} md={10}>
                      <Typography style={typographyStyle}>
                        What would you like in your party package?
                      </Typography>
                      <TextArea
